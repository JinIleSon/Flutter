...
void main(){
  ...
  print(a - b); // 7
  print(a * b); // 30
  print(a / b); // 3.3333333333333 (double)
  print(a ~/ b); // 3 (정수 나눗셈)
  print(a % b); // 1 (나머지)
  ...
  print(nullableString?.toUpperCase()); // ?.는 null이 아닐 경우 다음 함수를 호출
  ...
  // Null 강제 연산자
  int? maybeNumber = 3;
  int mustNotNullNumber = maybeNumber!; // Nullable 변수를 Non-Nullable 변수에 직접 대입은 안 된다. 그래서 null이 아님을 명확히 보장하기 위해 ! 사용
